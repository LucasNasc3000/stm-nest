...
export class New1773936951328 implements MigrationInterface {
  name = 'New1773936951328';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."outflow_reason_enum_old" AS ENUM('vencido', 'perdido', 'danificado', 'roubado', 'desperdício', 'outro')`,
    );
    await queryRunner.query(
